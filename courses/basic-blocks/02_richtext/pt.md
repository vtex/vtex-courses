...
Leia o Rich Text [documentação](https://vtex.io/docs/app/vtex.rich-text#blocks-api) mais uma vez e vamos definir os adereços que usaremos para personalizar o bloco.
